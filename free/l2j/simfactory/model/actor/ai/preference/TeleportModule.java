...
public class TeleportModule {
    ...
    public static final TCity[] TCities = {
        TCity.DWARVEN, TCity.ORC, TCity.DARK_ELVEN, TCity.ELVEN, TCity.TALKING_ISLAND,
        TCity.HEINE, TCity.DION, TCity.GIRAN, TCity.ADEN, TCity.GODDARD, TCity.GLUDIO,
        TCity.GLUDIN, TCity.SHTUTTGART, TCity.RUNE, TCity.OREN, TCity.HUNTER, TCity.NON_CITY
    };

    public static final String[] CityNames = {
        "dwarven village", "orc village", "dark elf village", "elf village", "talking island",
        "heine", "dion", "giran", "aden", "goddard", "gludio", "gludin", "schuttgart",
        "rune", "oren", "hunter village"
    };

    // IDs of the Gatekeepers
    public static final int[] GateKeepers = {
        30540, 30576, 30134, 30146, 30006,
        30899, 30059, 30080, 30848, 31275,
        30256, 30320, 31964, 31320, 30177, 30233
    };
